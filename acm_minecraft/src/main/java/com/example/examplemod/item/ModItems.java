...
public class ModItems {
    ...
    public static final RegistryObject<Item> EXAMPLE_HELMET = ITEMS.register("example_helmet",
            () -> new ArmorItem(ModArmorMaterials.ACMIUM, EquipmentSlot.HEAD, new Item.Properties().tab(ModCreativeModTab.TUTORIAL_TAB).stacksTo(1)));
    public static final RegistryObject<Item> EXAMPLE_CHESTPIECE = ITEMS.register("example_chestpiece",
            () -> new ArmorItem(ModArmorMaterials.ACMIUM,EquipmentSlot.CHEST, new Item.Properties().tab(ModCreativeModTab.TUTORIAL_TAB).stacksTo(1)));
    public static final RegistryObject<Item> EXAMPLE_LEGGINGS = ITEMS.register("example_leggings",
            () -> new ArmorItem(ModArmorMaterials.ACMIUM,EquipmentSlot.LEGS, new Item.Properties().tab(ModCreativeModTab.TUTORIAL_TAB).stacksTo(1)));
    public static final RegistryObject<Item> EXAMPLE_BOOTS = ITEMS.register("example_boots",
            () -> new ArmorItem(ModArmorMaterials.ACMIUM,EquipmentSlot.FEET, new Item.Properties().tab(ModCreativeModTab.TUTORIAL_TAB).stacksTo(1)));
